<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\zbs\zbs\public/../application/index\view\vote\index.html";i:1536586941;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
function more_vote(value,vote_id){
	$.post('vote' ,{rid:<?php echo $rid; ?>,vid:vote_id,v:value},function(data){
		if( data.status){
			top.layer.msg('投票成功');
		}else{
...
function show_vote(vid){
	$.post('show' ,{rid:<?php echo $rid; ?>,vid:vid},function(data){
		if( data.status){
